...
[<img alt='Imagine prim pas al instalării' src='{{site.baseurl}}/images/vagrant/macos/firststep.png' class="noshadow" />]({{site.baseurl}}/images/vagrant/macos/firststep.png)
